...
`gitmoji.toml` stands alone or layers onto another preset:
`extends = ["./conventional.toml", "./gitmoji.toml"]` requires an emoji in
front of a conventional header. It is generated by
